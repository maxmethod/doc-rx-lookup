...
//   window.MEDS_CONFIG = { initialMedications: '{{ contact.custom.medications_json }}' }
//   <div id="medications-lookup-widget" data-initial-medications="{{ contact.custom.medications_json }}">
function readInitialSeed() {
  ...
  let s = clean(cfg.initialMedications);
  if (s) return s;
  const el = document.getElementById('medications-lookup-widget');
  if (el) s = clean(el.getAttribute('data-initial-medications'));
  return s;
}
